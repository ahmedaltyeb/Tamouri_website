...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { labelKey: "giftBoxes",   href: "/gift-boxes" },
    { labelKey: "weeklyDeals", href: "/weekly-deals" },
  ] as const;
  ...
  return (
    <footer className="bg-ink text-white" dir={lang === "ar" ? "rtl" : "ltr"}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Contact info */}
          <div>
            <h4 className="font-bold text-sm mb-4 text-white/90">{tr("contactUs")}</h4>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/60 text-sm">{tr("location")}</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/60 text-sm">{tr("workingHours")}</span>
              </li>
            </ul>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-white/40 text-xs">
          ...
          <div className="flex gap-4">
            <a href="#" className="hover:text-white/70 transition-colors cursor-pointer">{tr("privacy")}</a>
            <a href="#" className="hover:text-white/70 transition-colors cursor-pointer">{tr("terms")}</a>
          </div>
        </div>
      </div>
    </footer>
