...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[560px] md:min-h-[640px] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 py-20 text-center">
        ...
        <p className="text-white/80 text-base md:text-lg font-medium mb-8 leading-relaxed max-w-xl mx-auto">
          {tr("heroSub1")}
        </p>
