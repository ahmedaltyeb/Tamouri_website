...
// Key = product ID. Values: nameEn, nameAr (and optional categoryAr).
// Only products whose Arabic name needs to be set or corrected are listed here.
const TRANSLATIONS: Record<string, { nameEn: string; nameAr: string; categoryAr?: string }> = {
  // ── Dates ──────────────────────────────────────────────────────────────────
  "cmqpmmjws0000v0icasjyyazq": { nameEn: "Premium Medjool Dates", nameAr: "تمر مجدول فاخر", categoryAr: "التمر" },
  ...
  "cmqqjw8ez000xv0j0r42cf548": { nameEn: "Dates of Happiness Mix – Dates Combining Authenticity and Unique Taste", nameAr: "مزيج تمر السعادة - تمر يجمع الأصالة والمذاق الفريد" },
  "cmqqjw9d00011v0j09p0yotuo": { nameEn: "Qassim Gold VIP Dates", nameAr: "تمر القصيم الذهبي VIP" },
  "cmqqjw9my0013v0j0256x0uzo": { nameEn: "Individually Wrapped Al-Qassim Khalas Dates – Premium for Hospitality", nameAr: "تمر خلاص القصيم مغلف منفرداً - فاخر للضيافة" },
  ...
  "cmqqjwbc3001dv0j03rucuiw2": { nameEn: "Premium Date Box – Variety of Selections for Gifts and Hospitality", nameAr: "صندوق تمر فاخر - تشكيلة متنوعة للهدايا والضيافة" },
  ...
  "cmqqjwcr3001nv0j0pafto2lb": { nameEn: "A Luxurious Date Presented in a Distinctive Gift Box", nameAr: "تمر فاخر مُقدَّم في صندوق هدايا مميز" },
  ...
  // ── Arabic Coffee ──────────────────────────────────────────────────────────
  "cmqpmmkbz0001v0icqrtyv4zr": { nameEn: "Arabic Coffee with Cardamom", nameAr: "قهوة عربية بالهيل", categoryAr: "القهوة العربية" },
  ...
  // ── Specialty Coffee ───────────────────────────────────────────────────────
  "cmqqjwmuv002zv0j0be3ifp7f": { nameEn: "Specialty Coffee Dabaye Guji Hambela", nameAr: "قهوة مختصة دباي غوجي هامبيلا", categoryAr: "القهوة المختصة" },
  ...
  "cmqqjwp2l003fv0j0x1bbfnzx": { nameEn: "Specialty Coffee – 4×250g Sachets (Buy 3 Get 4th Free)", nameAr: "قهوة مختصة - ٤ أكياس ٢٥٠ جرام (اشترِ ٣ واحصل على الرابع مجاناً)" },
  ...
  // ── Tea ────────────────────────────────────────────────────────────────────
  "cmqpmmkzg0003v0ic2dm7ywgt": { nameEn: "Emirati Karak Tea", nameAr: "شاي كرك إماراتي", categoryAr: "الشاي" },
  ...
  "cmqpmml8s0004v0icptansrf0": { nameEn: "Golden Dallah and Finjan Coffee Set", nameAr: "طقم دلة وفناجين ذهبي", categoryAr: "أدوات القهوة والشاي" },
  ...
  "cmqqjx0aa0057v0j0ian3nng9": { nameEn: "Coffee and Tea Cup and Saucer Set – Green and Yellow Design – 12 Pieces", nameAr: "طقم فناجين قهوة وشاي مع صحون - تصميم أخضر وأصفر - ١٢ قطعة" },
  ...
  "cmqqjx1nc005fv0j08w2zkfho": { nameEn: "Espresso Tamper (Mold)", nameAr: "تامبر الإسبريسو (قالب الضغط)" },
  "cmqqjx1yo005hv0j0ovgkjjaj": { nameEn: "Coffee Clump Breaker", nameAr: "كاسر تكتلات القهوة" },
  "cmqqjx27a005jv0j08jrckc4y": { nameEn: "Time More C3 Grinder – Manual Coffee Grinder", nameAr: "مطحنة تايم مور C3 - مطحنة قهوة يدوية" },
  ...
  // ── Travel Tools ───────────────────────────────────────────────────────────
  "cmqqjx46b005tv0j0monn2bmc": { nameEn: "BRS Portable 7000W Outdoor Stove (BRS-75)", nameAr: "موقد خارجي محمول BRS بقدرة ٧٠٠٠ واط (BRS-75)", categoryAr: "أدوات السفر والرحلات" },
  ...
  // ── Gift Boxes ─────────────────────────────────────────────────────────────
  "cmqpmmlgw0005v0icxdxkua4s": { nameEn: "Premium Hospitality Gift Box", nameAr: "بوكس هدايا الضيافة الفاخر", categoryAr: "صناديق الهدايا" },
  ...
  "cmqqjx5zs0065v0j0c3y4tfqr": { nameEn: "Nabil Nankhatai – Saffron & Cashew – Luxury Biscuits with Oriental Flavors", nameAr: "نبيل نانختاي - بسكويت فاخر بالزعفران والكاجو - بنكهات شرقية" },
};
...
export async function POST() {
  ...
  return NextResponse.json({
    message: `Arabic translations applied: ${results.updated} updated, ${results.skipped} skipped`,
    ...results,
  });
}
