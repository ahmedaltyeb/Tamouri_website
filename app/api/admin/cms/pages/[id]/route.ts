...
export async function PUT(request: Request, { params }: Ctx) {
  ...
  if ("heroImage"      in body) data.heroImage      = body.heroImage      ? String(body.heroImage)      : null;
  if ("heroImageAltEn" in body) data.heroImageAltEn = body.heroImageAltEn ? String(body.heroImageAltEn) : null;
  if ("heroImageAltAr" in body) data.heroImageAltAr = body.heroImageAltAr ? String(body.heroImageAltAr) : null;
