    ...
    <aside className="w-64 bg-white border-r border-stone-200 flex flex-col flex-shrink-0">
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        <div className="pt-3 pb-1">
          <p className="px-3 text-[10px] font-bold text-stone-400 uppercase tracking-widest">CMS</p>
        </div>
        <NavItem
          href="/admin/cms/hero"
          label="Hero Slides"
          active={pathname.startsWith("/admin/cms/hero")}
          icon={<ImageIcon />}
        />
        <NavItem
          href="/admin/cms/footer"
          label="Footer Sections"
          active={pathname.startsWith("/admin/cms/footer")}
          icon={<FooterIcon />}
        />
        <NavItem
          href="/admin/cms/payment-methods"
          label="Payment Methods"
          active={pathname.startsWith("/admin/cms/payment-methods")}
          icon={<PaymentIcon />}
        />
        <NavItem
        ...
        <NavItem
          ...
          label="Testimonials"
          active={pathname.startsWith("/admin/cms/testimonials")}
          icon={<TestimonialsIcon />}
        />
        <NavItem
          href="/admin/cms/features"
          label="Feature Cards"
          active={pathname.startsWith("/admin/cms/features")}
          icon={<FeatureCardsIcon />}
        />
        <NavItem
        ...
        <NavItem
          href="/admin/cms/menu"
          label="Menu"
          active={pathname.startsWith("/admin/cms/menu")}
          icon={<MenuIcon />}
        />

        {/* Insights */}
        <div className="pt-3 pb-1">
          <p className="px-3 text-[10px] font-bold text-stone-400 uppercase tracking-widest">Insights</p>
        </div>
        <NavItem
        ...
        {/* Settings */}
        <div className="pt-3 pb-1">
          <p className="px-3 text-[10px] font-bold text-stone-400 uppercase tracking-widest">Settings</p>
        </div>
        <NavItem
          href="/admin/settings/store"
          label="Store Settings"
          active={pathname.startsWith("/admin/settings/store")}
          icon={<SettingsIcon />}
        />
        <NavItem
          href="/admin/settings/theme"
          label="Theme & Fonts"
          active={pathname.startsWith("/admin/settings/theme")}
          icon={<ThemeIcon />}
        />
      </nav>
